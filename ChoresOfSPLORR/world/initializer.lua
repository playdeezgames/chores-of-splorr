...
local last_room = require "world.rooms.LAST"
...
function M.initialize()
	...
	local third_room_id = third_room.initialize_third_room(second_room_id)
	last_room.initialize_last_room(third_room_id)
end
